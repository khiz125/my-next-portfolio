 const en ={
  ...
  Job_now: "Frontend",
  Job_now_detail_1: "- Information and Communication Technology company, Japan.",
  ...
  Job_4: "Luxury Hotel Assistant Manager",
  ...
  Project_DesignBook_1: "My favorite web design features.",
  ...
  Project_Portfolio_1: "It's this portfolio web page. Developed using Next.js and TypeScript. Transions between pages are built with Framer motion.",
